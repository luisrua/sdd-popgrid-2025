# POPULATION GRID NAURU - NRU - 2025 UPDATE

# Use of census data and country projections to generate 33m and 100m resolution 
# population grids dissagregated by age and sex
...
stata_files <- list.files (glue("C:/Users/{user}/OneDrive - SPC/NADA/Nauru/SPC_NRU_2021_PHC_v01_M/Data/Original"),
...
raster_data <- rast(paste0(dd,"raster/NRU_tpop_2025.tif"))
...
# title
title_text <- "<div style='font-family: Calibri, sans-serif; font-size: 22px; font-weight: bold;'>NAURU - 2025 Population Grid</div>"
...
saveWidget(map_sat, file = paste0(dmap,country, "_ppg_2025.html"), selfcontained = TRUE)
...
ab <- st_read(paste0(dd,"layers/Nau_did_3857.shp"))
...
tm_map <- tm_shape(ab)+
  ...
  tm_raster(style = "cont", 
            ...
            alpha = 0.8) +
  tm_layout(main.title = "NAURU - 2025 Population Grid",
